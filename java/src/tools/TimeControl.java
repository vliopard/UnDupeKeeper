...
/**
 * TimeControl class is responsible to manage time calculations for benchmarking.
 * 
 * @author vliopard
 */
public class TimeControl
{
     ...
     * 
     * @return Returns a <code>long</code> value that represents the time in milliseconds.
     */
     ...
     * 
     * @return Returns a <code>long</code> value that represents the time in nanoseconds.
     */
     ...
     * 
     * @param start
     *                  A <code>long</code> value containing the start time to calculate delta from end.
     * 
     * @return Returns a <code>long</code> value that represents the interval of time in milliseconds.
     */
     ...
     *                  A <code>long</code> value containing the start time to calculate delta from end.
     * 
     * @return Returns a <code>long</code> value that represents the interval of time in nanoseconds.
     */
     ...
     * 
     * @param time
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns a <code>long</code> value that represents the time in to microseconds.
     */
     ...
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns a <code>long</code> value that represents the time in to milliseconds.
     */
     ...
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns a <code>long</code> value that represents the time in to seconds.
     */
     ...
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns a <code>long</code> value that represents the time in to minutes.
     */
     ...
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns a <code>long</code> value that represents the time in to hours.
     */
     ...
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns a <code>long</code> value that represents the time in to days.
     */
     ...
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns an <code>String</code> value that represents the formatted time in Hour:Minutes:Seconds.
     */
    ...
    /**
     * This method returns the time formated in Hour:Minutes:Seconds:Milliseconds:Microseconds.
     * 
     * @param time
     *                 A <code>long</code> value containing the nanoseconds to be converted.
     * 
     * @return Returns an <code>String</code> value that represents the formatted time in
