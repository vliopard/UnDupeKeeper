...
public class Options extends JDialog
{
     ...
     *                            A <code>SettingsHandler</code> object that contains all the user settings to be
     *                            handled.
     */
...
class OptionsLayout implements LayoutManager
{
    ...
    /**
     * OptionsLayout Constructor - It is empty since no action should be taken for this part of code.
     */
    ...
    /**
     * Just an inherited method from LayoutManager, not used in this project yet.
     */
    ...
    /**
     * This method sets an array of <code>Insets</code> containing the components sizes of the settings screen.
     * 
     * @param i
     *                   An <code>int</code> value that represents the order the component is placed.
     * @param left
     *                   An <code>int</code> value that represents the left position of the component.
     * @param top
     *                   An <code>int</code> value that represents the top position of the component.
     * @param right
     *                   An <code>int</code> value that represents the right position of the component.
     * @param bottom
     *                   An <code>int</code> value that represents the bottom position of the component.
     */
    ...
    /**
     * It creates the places where all component objects will be placed on settings dialog.
     */
    public void layoutContainer(Container parent)
    {
        ...
        for (int i = 0; i < values.length; i++)
        {
            ...
            {
                component.setBounds(insets.left + values[i].left, insets.top
                        + values[i].top, values[i].right, values[i].bottom);
            }
        }
    }
}
