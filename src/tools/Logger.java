...
/**
 * Logger class is responsible for centralize debug and message mechanism, allowing developer to use filters and levels
 * of displaying message, controlling source code by sectors.
 * 
 * @author vliopard
 */
public class Logger
{
    ...
    /**
     * This method displays an error message using the default error output system.
     * 
     * @param errorMessage
    ...
    /**
     * This is a formatter that places a log message with two tab separated values.
     * 
     * @param debugModule
     *                         A <code>String</code> that contains the module identification that will be displayed.
     * @param debugMessage
    ...
    /**
     * This is the main log handler. It decides what to display according to the developer settings.
     * 
     * @param threadStackTrace
     *                             A <code>Thread</code> object from parent object that contains a stack trace.
     * @param logMessage
     *                             A <code>String</code> containing the log message that will be displayed.
     * @param systemModule
     *                             An <code>int</code> value that represents the module that is being executed.
     */
