...
DEBUG_GUI = f'{DEBUG_BASE}_GUI'
DEBUG_DB = f'{DEBUG_BASE}_DB'
DEBUG_CP = f'{DEBUG_BASE}_CP'
DEBUG_CORE = f'{DEBUG_BASE}_CORE'
DEBUG_HASH = f'{DEBUG_BASE}_HASH'
DEBUG_DIR = f'{DEBUG_BASE}_DIR'
DEBUG_COUNT = f'{DEBUG_BASE}_COUNT'
DEBUG_DASHBOARD = f'{DEBUG_BASE}_DASHBOARD'
DEBUG_METHODS = f'{DEBUG_BASE}_METHODS'
DEBUG_SETUP = f'{DEBUG_BASE}_SETUP'
DEBUG_DIFF = f'{DEBUG_BASE}_DIFF'
DEBUG_BENCHMARK = f'{DEBUG_BASE}_BENCHMARK'
